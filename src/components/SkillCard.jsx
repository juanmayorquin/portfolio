...
const SkillCard = ({ Icon, name, color }) => {
  return (
    <motion.article
      ...
      viewport={{ once: true }}
      animate
      className="flex w-56 gap-6 p-4 border-2 border-white/5 hover:border-current rounded-lg hover:cursor-default transition-all duration-200 group ease-in-out"
      style={{ color }}
    >
